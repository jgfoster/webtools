...
initialize: aString
	...
	myStream ifNil: [self error: GsFile serverErrorString].
...
upTo: aCharacter
	...
	string := stream next: 15000.
	string ifNil: [self error: stream lastErrorString].
	cache addAll: string.
